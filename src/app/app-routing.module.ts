...
const routes: Routes = [
  { path: 'admin-delivery', component: DeliveryComponent, canActivate: [AuthGuard] },
  ...
  {path:'main-menu-admin',component:MainMenuAdminComponent, canActivate: [AuthGuard]},
  { path: 'contacto', component: ContactoComponent },
  { path: 'nosotros', component: NosotrosComponent},
  // Ingredientes
  { path: 'listingredients', component: ListProductsComponent, canActivate: [AuthGuard] },
  { path: 'listingredients/add', component: AddEditProductComponent, canActivate: [AuthGuard] },
  { path: 'listingredients/edit/:codIngrediente', component: AddEditProductComponent, canActivate: [AuthGuard] },
  // Hamburguesas
  { path: 'listhamburguesas', component: ListHamburguesasComponent, canActivate: [AuthGuard] },
  { path: 'listhamburguesas/add', component: AddEditHamburguesaComponent, canActivate: [AuthGuard] },
  { path: 'listhamburguesas/edit/:idHamburguesa', component: AddEditHamburguesaComponent, canActivate: [AuthGuard] },
   // Clientes
   ...
   { path: 'listpedidos/edit/:idPedido', component: AddEditPedidoComponent, canActivate: [AuthGuard] },
